...
> This doc is the **source of truth** for the Copilot prompt-quality gate (`.github/copilot-instructions.md`, `.github/instructions/`, and `.github/prompts/`). Those files are derived from these rules — keep them in sync when the rules here change.
